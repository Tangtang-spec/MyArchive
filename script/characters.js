...
function createCharacterCard(data) {
    ...
    card.querySelector(".btn-edit-char").addEventListener("click", () => openCharModal(data));
    card.querySelector(".btn-rel-char").addEventListener("click", () => openRelModal(data));
    card.querySelector(".btn-delete-char").addEventListener("click", () => deleteCharacter(data.id, data.name));
